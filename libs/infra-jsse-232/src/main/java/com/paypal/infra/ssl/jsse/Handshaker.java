...
import static com.paypal.infra.ssl.jsse.CipherSuite.PRF.*;
import static com.paypal.infra.ssl.jsse.CipherSuite.CipherType.*;
...
abstract class Handshaker {
    ...
    static final Debug debug = Debug.getInstance("com/paypal/infra/ssl");
