...
public abstract class SSLContextImpl extends SSLContextSpi {
    ...
    private abstract static class AbstractTLSContext extends SSLContextImpl {
        ...
        ProtocolList getServerDefaultProtocolList() {
        	// PayPal - get protocols from protected and set as default
        	if (PayPalJSSEProperties.getServerProtocolsEnabled() != null)
        		return new ProtocolList(PayPalJSSEProperties.getServerProtocolsEnabled());
        	else
        ...
        CipherSuiteList getServerDefaultCipherSuiteList() {
        	// PayPal - get cipher suites from protected and set as default
        	if (PayPalJSSEProperties.getServerCipherSuites() != null) 
        		return new CipherSuiteList(PayPalJSSEProperties.getServerCipherSuites());
        	else
    ...
    public static final class TLS10Context extends AbstractTLSContext {
        ...
        ProtocolList getClientDefaultProtocolList() {
        	...
        	if (PayPalJSSEProperties.getClientProtocolsEnabled() != null)
        		return new ProtocolList(PayPalJSSEProperties.getClientProtocolsEnabled());
        	else
        ...
        CipherSuiteList getClientDefaultCipherSuiteList() {
        	...
        	if (PayPalJSSEProperties.getClientCipherSuites() != null)
        		return new CipherSuiteList(PayPalJSSEProperties.getClientCipherSuites());
        	else
