...
class SSLServerSocketImpl extends SSLServerSocket
{
    ...
    synchronized public void setEnabledProtocols(String[] protocols) {
		// PayPal specific change - don't let client to change protocol if it is
		// set via system property.this is require to enforce supported
		// protocols
		if (PayPalJSSEProperties.getServerProtocolsEnabled() != null)
			return;
		// End
    ...
    public boolean getNeedClientAuth() {
		// PayPal specific change to return Client Auth configuration
		return (PayPalJSSEProperties.getClientAuth() == SSLEngineImpl.clauth_required);
    ...
    public void setWantClientAuth(boolean flag) {
    	// PayPal specific change - dont let client to set client auth option instead read it from protected.cfg
        /*doClientAuth = (flag ?
    ...
    public boolean getWantClientAuth() {
    	// PayPal specific change to return Client Auth configuration
    	return (PayPalJSSEProperties.getClientAuth() == SSLEngineImpl.clauth_requested);
