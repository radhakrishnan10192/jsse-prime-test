...
final public class SSLEngineImpl extends SSLEngine {
            ...
            synchronized (this) {
                ...
                case Record.ct_handshake:
                    ...
                    if (handshaker.invalidated) {
                        ...
                        handshakeSession = null;
						// PayPal
						if (!writer.hasOutboundData() || (sess instanceof PayPalSSLSession && sess.isResumed())) {
							hsStatus = HandshakeStatus.FINISHED;
							// call back cache provider for letting handshake
							// complete. require for cal logging
    ...
    synchronized public void setNeedClientAuth(boolean flag) {
    	// PayPal specific change - don't let client to set client auth option instead read it from protected.cfg
        /*doClientAuth = (flag ?
    ...
    synchronized public void setEnabledCipherSuites(String[] suites) {
		// PayPal specific change - Allow setting cipher suites only if it is
		// not set via protected/keymaker.
		// cipher suite will be controller via protected/keymaker property
		if ((roleIsServer && PayPalJSSEProperties.getServerCipherSuites() != null)
				|| (!roleIsServer && PayPalJSSEProperties.getClientCipherSuites() != null))
			return;
		// End
    ...
    synchronized public void setEnabledProtocols(String[] protocols) {
		// PayPal specific change - Allow setting protocol only if it is not set
		// via protected/keymaker.
		// protocol will be controller via protected/keymaker property
		if ((roleIsServer && PayPalJSSEProperties.getServerProtocolsEnabled() != null)
				|| (!roleIsServer && PayPalJSSEProperties.getClientProtocolsEnabled() != null))
			return;
		// End
